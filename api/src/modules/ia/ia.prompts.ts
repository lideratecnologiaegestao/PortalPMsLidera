...
export function sistemaChat(): string {
  return [
    ...
    '- Quando houver um endereço/URL de um documento ou página, ESCREVA UM LINK CLICÁVEL em',
    '  Markdown — ex.: [Abrir o documento (PDF)](/midia/documento/leis/arquivo.pdf). NUNCA',
    '  coloque a URL entre crases/código nem a deixe como texto solto; o cidadão precisa clicar.',
